...
class CommandTypeTest {
    ...
    void allCommandStringsAndFullNamesLocked() {
        ...
        expectedString.put(CommandType.BLU3PRINT, "blu3print");
        expectedFull.put(CommandType.BLU3PRINT, "blu3print");

        expectedString.put(CommandType.DUPLICATE, "duplicate");
        expectedFull.put(CommandType.DUPLICATE, "blu3print.duplicate");

        expectedString.put(CommandType.FACE, "face");
        expectedFull.put(CommandType.FACE, "blu3print.face");

        expectedString.put(CommandType.ROTATE, "rotate");
        expectedFull.put(CommandType.ROTATE, "blu3print.rotate");

        expectedString.put(CommandType.TURN, "turn");
        expectedFull.put(CommandType.TURN, "blu3print.turn");

        expectedString.put(CommandType.IMPORT, "import");
        expectedFull.put(CommandType.IMPORT, "blu3print.import");

        expectedString.put(CommandType.EXPORT, "export");
        expectedFull.put(CommandType.EXPORT, "blu3print.export");

        expectedString.put(CommandType.SCALE, "scale");
        expectedFull.put(CommandType.SCALE, "blu3print.scale");

        expectedString.put(CommandType.NAME, "name");
        expectedFull.put(CommandType.NAME, "blu3print.name");

        expectedString.put(CommandType.GIVE, "give");
        expectedFull.put(CommandType.GIVE, "blu3print.give");

        expectedString.put(CommandType.HELP, "help");
        expectedFull.put(CommandType.HELP, "blu3print.help");

        expectedString.put(CommandType.CONFIG, "config");
        expectedFull.put(CommandType.CONFIG, "blu3print.config");

        expectedString.put(CommandType.PLAYER, "player-config");
        expectedFull.put(CommandType.PLAYER, "blu3print.player-config");

        expectedString.put(CommandType.GLOBAL, "global-config");
        expectedFull.put(CommandType.GLOBAL, "blu3print.global-config");
